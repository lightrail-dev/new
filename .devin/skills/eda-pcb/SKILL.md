---
name: eda-pcb
description: PCB layout, component placement, and routing skill for KiCad-based hardware designs. Activates when working with .kicad_pcb files, placement, routing, copper pours, vias, DFM, trace width, or clearance.
---
...
| Layer count decided | design-constraints.json | Create LAYER-COUNT-DECISION.md |
| Stackup selected | design-constraints.json | Create STACKUP-DECISION.md |
...
| Condition | Warning |
|-----------|---------|
| USB + 2-layer board | Cannot achieve 90 Ohm impedance |
...
3. USB differential pairs (90 Ohm impedance)
...
- Minimize vias
- Avoid acute angles (use 45 degrees)
...
| USB traces | 90 Ohm impedance, length matched | HIGH-SPEED-ROUTING.md |
