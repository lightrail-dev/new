...
6. **No Gerbers checked in.** Gerbers, drills, IPC-D-356 netlist, pick-and-
   ...
   passes DRC.
7. **Stackup is 10-layer Megtron-7.** A real 1000 A+ (NCE + 4× HBM4 combined)
   / PCIe Gen 6 board typically needs 20–26 layers with multiple thick-copper
   V_core planes and dedicated reference planes for every high-speed lane.
   Current scaffold keeps 10 layers for KiCad file-size tractability.
